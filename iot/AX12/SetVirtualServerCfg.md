...
![image-20231122103452997](https://e4l4pic.oss-cn-beijing.aliyuncs.com/image-20231122103452997.png)

In the /goform/SetVirtualServerCfg function, passing a value to the list parameter assigns it to v3. Within this function, the sscanf function triggers a stack overflow.
